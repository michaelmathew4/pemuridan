...
class DataLembagaController extends Controller
{
  ...
  {
    $namaKelompok = Nama_kelompok::join('data_lembagas', 'nama_kelompoks.id_ketua_kelompok', '=', 'data_lembagas.id_user')
                ->select('nama_kelompoks.*')
                ->where('nama_kelompoks.id_ketua_kelompok', $id)
                ->get();

    return response()->json(["namaKelompok" => $namaKelompok]);
  } 
  ...
  public function indexPengurusPM()
  {
    ...
    return view('parousia-ministry.pengurus.data-lembaga', compact(['dataLembagas', 'nodataLembagas', 'noNamaKelompoks', 'pekerjaans', 'statusPekerjaans', 'lokasis', 'sektorIndustris', 'tingkatPendidikans', 'sekolahUnivs',
                                                      'bidKeterampilans', 'bidKetertarikans', 'persMbtis', 'persHollands', 'spiritGifts', 'abilities', 'gandaLimas', 'kemBahasas',
                                                      'kc_pilsatus', 'kc_pilduas', 'kc_piltigas', 'kc_pilempats', 'kc_pillimas', 'kc_pilenams', 'kc_piltujuhs', 'nominals', 'namaKelompoks']));
  }

  
  function randomCodesPengurusKKPM()
  {
    do {
      $kode = random_int(100000000, 999999999);
    } while (Nominal::where("id_nominal", "=", $kode)->first());
  ...
  public function storePengurusPM(Request $request)
  {
    ...
    if($storeDataSave){
      if ($request->tambahNominals != '') {
        foreach ($request->tambahNominals as $key => $isiTambahNominal) {
          $storeNominals = new Nominal;
          $storeNominals->id_nominal = $this->randomCodesPengurusKKPM();
          $storeNominals->id_user = $request->idDatas;
          $storeNominals->keterangan_nominal = $isiTambahNominal['ket_nominal'];
          $storeNominals->nominal = $isiTambahNominal['nominal'];
          $storeNominals->save();
      ...
      if ($addUser) {
        return redirect()->route('data-lembaga.indexPengurusPM')->with(['success' => 'Data Berhasil Disimpan!']);
      }else{
        return redirect()->route('data-lembaga.indexPengurusPM')->with(['error' => 'Data Gagal Disimpan!']);
      }
    }else{
      return redirect()->route('data-lembaga.indexPengurusPM')->with(['error' => 'Data Gagal Disimpan!']);
    }
  ...
  public function destroyPengurusPM($id)
  {
    ...
    if($deleteData){
      return redirect()->route('data-lembaga.indexPengurusPM')->with(['success' => 'Data Berhasil Dihapus!']);
    }else{
      return redirect()->route('data-lembaga.indexPengurusPM')->with(['error' => 'Data Gagal Dihapus!']);
    }
  } 
  ...
  public function indexKetuaLokasiPM()
  {
    ...
    return view('parousia-ministry.ketua-lokasi.data-lembaga', compact(['dataLembagas', 'nodataLembagas', 'noNamaKelompoks', 'pekerjaans', 'statusPekerjaans', 'lokasis', 'sektorIndustris', 'tingkatPendidikans', 'sekolahUnivs',
                                                      'bidKeterampilans', 'bidKetertarikans', 'persMbtis', 'persHollands', 'spiritGifts', 'abilities', 'gandaLimas', 'kemBahasas',
                                                      'kc_pilsatus', 'kc_pilduas', 'kc_piltigas', 'kc_pilempats', 'kc_pillimas', 'kc_pilenams', 'kc_piltujuhs', 'nominals', 'namaKelompoks']));
  }

  
  function randomCodesKetuaLokasiKKPM()
  {
    do {
      $kode = random_int(100000000, 999999999);
    } while (Nominal::where("id_nominal", "=", $kode)->first());
  ...
  public function storeKetuaLokasiPM(Request $request)
  {
    ...
    if($storeDataSave){
      if ($request->tambahNominals != '') {
        foreach ($request->tambahNominals as $key => $isiTambahNominal) {
          $storeNominals = new Nominal;
          $storeNominals->id_nominal = $this->randomCodesKetuaLokasiKKPM();
          $storeNominals->id_user = $request->idDatas;
          $storeNominals->keterangan_nominal = $isiTambahNominal['ket_nominal'];
          $storeNominals->nominal = $isiTambahNominal['nominal'];
          $storeNominals->save();
      ...
      if ($addUser) {
        return redirect()->route('data-lembaga.indexKetuaLokasiPM')->with(['success' => 'Data Berhasil Disimpan!']);
      }else{
        return redirect()->route('data-lembaga.indexKetuaLokasiPM')->with(['error' => 'Data Gagal Disimpan!']);
      }
    }else{
      return redirect()->route('data-lembaga.indexKetuaLokasiPM')->with(['error' => 'Data Gagal Disimpan!']);
    }
  ...
  public function destroyKetuaLokasiPM($id)
  {
    ...
    if($deleteData){
      return redirect()->route('data-lembaga.indexKetuaLokasiPM')->with(['success' => 'Data Berhasil Dihapus!']);
    }else{
      return redirect()->route('data-lembaga.indexKetuaLokasiPM')->with(['error' => 'Data Gagal Dihapus!']);
    }
  } 
  ...
  public function indexPengurusGKP()
  {
    ...
    return view('gereja-kristen-parousia.pengurus.data-lembaga', compact(['dataLembagas', 'nodataLembagas', 'noNamaKelompoks', 'pekerjaans', 'statusPekerjaans', 'lokasis', 'sektorIndustris', 'tingkatPendidikans', 'sekolahUnivs',
                                                      'bidKeterampilans', 'bidKetertarikans', 'persMbtis', 'persHollands', 'spiritGifts', 'abilities', 'gandaLimas', 'kemBahasas',
                                                      'kc_pilsatus', 'kc_pilduas', 'kc_piltigas', 'kc_pilempats', 'kc_pillimas', 'kc_pilenams', 'kc_piltujuhs', 'nominals', 'namaKelompoks']));
  }

  
  function randomCodesPengurusKKGKP()
  {
    do {
      $kode = random_int(100000000, 999999999);
    } while (Nominal::where("id_nominal", "=", $kode)->first());
  ...
  public function storePengurusGKP(Request $request)
  {
    ...
    if($storeDataSave){
      if ($request->tambahNominals != '') {
        foreach ($request->tambahNominals as $key => $isiTambahNominal) {
          $storeNominals = new Nominal;
          $storeNominals->id_nominal = $this->randomCodesPengurusKKGKP();
          $storeNominals->id_user = $request->idDatas;
          $storeNominals->keterangan_nominal = $isiTambahNominal['ket_nominal'];
          $storeNominals->nominal = $isiTambahNominal['nominal'];
          $storeNominals->save();
      ...
      if ($request->institusiDatas == 'GKP (Gereja Kristen Parousia)') {
        $institusi = 'GKP';
      } else {
        $institusi = 'PM';
      }
      ...
      if ($addUser) {
        return redirect()->route('data-lembaga.indexPengurusGKP')->with(['success' => 'Data Berhasil Disimpan!']);
      }else{
        return redirect()->route('data-lembaga.indexPengurusGKP')->with(['error' => 'Data Gagal Disimpan!']);
      }
    }else{
      return redirect()->route('data-lembaga.indexPengurusGKP')->with(['error' => 'Data Gagal Disimpan!']);
    }
  ...
  public function destroyPengurusGKP($id)
  {
    ...
    if($deleteData){
      return redirect()->route('data-lembaga.indexPengurusGKP')->with(['success' => 'Data Berhasil Dihapus!']);
    }else{
      return redirect()->route('data-lembaga.indexPengurusGKP')->with(['error' => 'Data Gagal Dihapus!']);
    }
  } 
  ...
  public function indexKetuaLokasiGKP()
  {
    ...
    return view('gereja-kristen-parousia.ketua-lokasi.data-lembaga', compact(['dataLembagas', 'nodataLembagas', 'noNamaKelompoks', 'pekerjaans', 'statusPekerjaans', 'lokasis', 'sektorIndustris', 'tingkatPendidikans', 'sekolahUnivs',
                                                      'bidKeterampilans', 'bidKetertarikans', 'persMbtis', 'persHollands', 'spiritGifts', 'abilities', 'gandaLimas', 'kemBahasas',
                                                      'kc_pilsatus', 'kc_pilduas', 'kc_piltigas', 'kc_pilempats', 'kc_pillimas', 'kc_pilenams', 'kc_piltujuhs', 'nominals', 'namaKelompoks']));
  }

  
  function randomCodesKetuaLokasiKKGKP()
  {
    do {
      $kode = random_int(100000000, 999999999);
    } while (Nominal::where("id_nominal", "=", $kode)->first());
  ...
  public function storeKetuaLokasiGKP(Request $request)
  {
    ...
    if($storeDataSave){
      if ($request->tambahNominals != '') {
        foreach ($request->tambahNominals as $key => $isiTambahNominal) {
          $storeNominals = new Nominal;
          $storeNominals->id_nominal = $this->randomCodesKetuaLokasiKKGKP();
          $storeNominals->id_user = $request->idDatas;
          $storeNominals->keterangan_nominal = $isiTambahNominal['ket_nominal'];
          $storeNominals->nominal = $isiTambahNominal['nominal'];
          $storeNominals->save();
      ...
      if ($addUser) {
        return redirect()->route('data-lembaga.indexKetuaLokasiGKP')->with(['success' => 'Data Berhasil Disimpan!']);
      }else{
        return redirect()->route('data-lembaga.indexKetuaLokasiGKP')->with(['error' => 'Data Gagal Disimpan!']);
      }
    }else{
      return redirect()->route('data-lembaga.indexKetuaLokasiGKP')->with(['error' => 'Data Gagal Disimpan!']);
    }
  ...
  public function destroyKetuaLokasiGKP($id)
  {
    ...
    if($deleteData){
      return redirect()->route('data-lembaga.indexKetuaLokasiGKP')->with(['success' => 'Data Berhasil Dihapus!']);
    }else{
      return redirect()->route('data-lembaga.indexKetuaLokasiGKP')->with(['error' => 'Data Gagal Dihapus!']);
    }
  } 
}
