...
class KetuaKelompokController extends Controller
{
  ...
  public function index()
  {
    ...
    return view('admin.data-ketua-kelompok', compact(['ketuaKelompoks', 'noKetuaKelompoks', 'pekerjaans', 'statusPekerjaans', 'lokasis', 'sektorIndustris', 'tingkatPendidikans', 'sekolahUnivs',
  ...
  public function store(Request $request)
  {
    ...
    [
      ...
      'lokasiKKs.required' => 'Lokasi tidak boleh kosong.',
    ...
    $storeData->lokasiKK = $request->lokasiKKs;
  ...
  public function indexPengurusYMP()
  {
    ...
    return view('ymp.pengurus.data-ketua-kelompok', compact(['ketuaKelompoks', 'noKetuaKelompoks', 'pekerjaans', 'statusPekerjaans', 'lokasis', 'sektorIndustris', 'tingkatPendidikans', 'sekolahUnivs',
                                                      'bidKeterampilans', 'bidKetertarikans', 'persMbtis', 'persHollands', 'spiritGifts', 'abilities', 'gandaLimas', 'kemBahasas', 'penyakits',
                                                      'kc_pilsatus', 'kc_pilduas', 'kc_piltigas', 'kc_pilempats', 'kc_pillimas', 'kc_pilenams', 'kc_piltujuhs']));
  }

  function randomCodePengurusYMP()
  {
    do {
      $kode = random_int(100000000, 999999999);
    } while (Ketua_kelompok::where("id_user", "=", $kode)->first());
  ...
  public function storePengurusYMP(Request $request)
  {
    ...
    $storeData = new Ketua_kelompok;
    $storeData->id_user = $this->randomCodePengurusYMP();
    $storeData->tanggal_registKK = $request->tglRegistrasiKetuaKelompoks;
    $storeData->refrensiKK = $request->referensiKetuaKelompoks;
    $storeData->sapaanKK = $request->sapaanKetuaKelompoks;
    $storeData->gelar_awalanKK = $request->gelarAwalanKetuaKelompoks;
    ...
    if($storeData){
      ...
      if ($addUser) {
        return redirect()->route('data-ketua-kelompok.indexPengurusYMP')->with(['success' => 'Ketua Kelompok Berhasil Disimpan!']);
      }else{
        return redirect()->route('data-ketua-kelompok.indexPengurusYMP')->with(['error' => 'Ketua Kelompok Gagal Disimpan!']);
      }
    }else{
      return redirect()->route('data-ketua-kelompok.indexPengurusYMP')->with(['error' => 'Ketua Kelompok Gagal Disimpan!']);
    }
  ...
  public function destroyPengurusYMP($id)
  {
    ...
    if($deleteDataKetuaKelompok){
      return redirect()->route('data-ketua-kelompok.indexPengurusYMP')->with(['success' => 'Ketua Kelompok Berhasil Dihapus!']);
    }else{
      return redirect()->route('data-ketua-kelompok.indexPengurusYMP')->with(['error' => 'Ketua Kelompok Gagal Dihapus!']);
    }
  }
  ...
  public function indexKetuaLokasiYMP()
  {
    ...
    return view('ymp.ketua-lokasi.data-ketua-kelompok', compact(['ketuaKelompoks', 'noKetuaKelompoks', 'pekerjaans', 'statusPekerjaans', 'lokasis', 'sektorIndustris', 'tingkatPendidikans', 'sekolahUnivs',
                                                      'bidKeterampilans', 'bidKetertarikans', 'persMbtis', 'persHollands', 'spiritGifts', 'abilities', 'gandaLimas', 'kemBahasas', 'penyakits',
                                                      'kc_pilsatus', 'kc_pilduas', 'kc_piltigas', 'kc_pilempats', 'kc_pillimas', 'kc_pilenams', 'kc_piltujuhs']));
  }

  function randomCodeKetuaLokasiYMP()
  {
    do {
      $kode = random_int(100000000, 999999999);
    } while (Ketua_kelompok::where("id_user", "=", $kode)->first());
  ...
  public function storeKetuaLokasiYMP(Request $request)
  {
    ...
    $storeData = new Ketua_kelompok;
    $storeData->id_user = $this->randomCodeKetuaLokasiYMP();
    $storeData->tanggal_registKK = $request->tglRegistrasiKetuaKelompoks;
    $storeData->refrensiKK = $request->referensiKetuaKelompoks;
    $storeData->sapaanKK = $request->sapaanKetuaKelompoks;
    $storeData->gelar_awalanKK = $request->gelarAwalanKetuaKelompoks;
    ...
    if($storeData){
      ...
      if ($addUser) {
        return redirect()->route('data-ketua-kelompok.indexKetuaLokasiYMP')->with(['success' => 'Ketua Kelompok Berhasil Disimpan!']);
      }else{
        return redirect()->route('data-ketua-kelompok.indexKetuaLokasiYMP')->with(['error' => 'Ketua Kelompok Gagal Disimpan!']);
      }
    }else{
      return redirect()->route('data-ketua-kelompok.indexKetuaLokasiYMP')->with(['error' => 'Ketua Kelompok Gagal Disimpan!']);
    }
  ...
  public function destroyKetuaLokasiYMP($id)
  {
    ...
    if($deleteDataKetuaKelompok){
      return redirect()->route('data-ketua-kelompok.indexKetuaLokasiYMP')->with(['success' => 'Ketua Kelompok Berhasil Dihapus!']);
    }else{
      return redirect()->route('data-ketua-kelompok.indexKetuaLokasiYMP')->with(['error' => 'Ketua Kelompok Gagal Dihapus!']);
    }
  }
  ...
  {
    $ketuaKelompoks = Ketua_kelompok::where('institusiKK', 'GKP (Gereja Kristen Parousia)');
    $noKetuaKelompoks = 1;
    ...
    return view('gkp.pengurus.data-ketua-kelompok', compact(['ketuaKelompoks', 'noKetuaKelompoks', 'pekerjaans', 'statusPekerjaans', 'lokasis', 'sektorIndustris', 'tingkatPendidikans', 'sekolahUnivs',
                                                      'bidKeterampilans', 'bidKetertarikans', 'persMbtis', 'persHollands', 'spiritGifts', 'abilities', 'gandaLimas', 'kemBahasas', 'penyakits',
                                                      'kc_pilsatus', 'kc_pilduas', 'kc_piltigas', 'kc_pilempats', 'kc_pillimas', 'kc_pilenams', 'kc_piltujuhs']));
  }

  function randomCodePengurusGKP()
  {
    do {
      $kode = random_int(100000000, 999999999);
    } while (Ketua_kelompok::where("id_user", "=", $kode)->first());
  ...
  public function storePengurusGKP(Request $request)
  {
    ...
    $storeData = new Ketua_kelompok;
    $storeData->id_user = $this->randomCodePengurusGKP();
    $storeData->tanggal_registKK = $request->tglRegistrasiKetuaKelompoks;
    $storeData->refrensiKK = $request->referensiKetuaKelompoks;
    $storeData->sapaanKK = $request->sapaanKetuaKelompoks;
    $storeData->gelar_awalanKK = $request->gelarAwalanKetuaKelompoks;
    ...
    if($storeData){
      ...
      if ($addUser) {
        return redirect()->route('data-ketua-kelompok.indexPengurusGKP')->with(['success' => 'Ketua Kelompok Berhasil Disimpan!']);
      }else{
        return redirect()->route('data-ketua-kelompok.indexPengurusGKP')->with(['error' => 'Ketua Kelompok Gagal Disimpan!']);
      }
    }else{
      return redirect()->route('data-ketua-kelompok.indexPengurusGKP')->with(['error' => 'Ketua Kelompok Gagal Disimpan!']);
    }
  ...
  public function destroyPengurusGKP($id)
  {
    ...
    if($deleteDataKetuaKelompok){
      return redirect()->route('data-ketua-kelompok.indexPengurusGKP')->with(['success' => 'Ketua Kelompok Berhasil Dihapus!']);
    }else{
      return redirect()->route('data-ketua-kelompok.indexPengurusGKP')->with(['error' => 'Ketua Kelompok Gagal Dihapus!']);
    }
  }
  ...
  {
    $ketuaKelompoks = Ketua_kelompok::where('institusiKL', 'GKP (Gereja Kristen Parousia)');
    $noKetuaKelompoks = 1;
    ...
    return view('gkp.ketua-lokasi.data-ketua-kelompok', compact(['ketuaKelompoks', 'noKetuaKelompoks', 'pekerjaans', 'statusPekerjaans', 'lokasis', 'sektorIndustris', 'tingkatPendidikans', 'sekolahUnivs',
                                                      'bidKeterampilans', 'bidKetertarikans', 'persMbtis', 'persHollands', 'spiritGifts', 'abilities', 'gandaLimas', 'kemBahasas', 'penyakits',
                                                      'kc_pilsatus', 'kc_pilduas', 'kc_piltigas', 'kc_pilempats', 'kc_pillimas', 'kc_pilenams', 'kc_piltujuhs']));
  }

  function randomCodeKetuaLokasiGKP()
  {
    do {
      $kode = random_int(100000000, 999999999);
    } while (Ketua_kelompok::where("id_user", "=", $kode)->first());
  ...
  public function storeKetuaLokasiGKP(Request $request)
  {
    ...
    $storeData = new Ketua_kelompok;
    $storeData->id_user = $this->randomCodeKetuaLokasiGKP();
    $storeData->tanggal_registKK = $request->tglRegistrasiKetuaKelompoks;
    $storeData->refrensiKK = $request->referensiKetuaKelompoks;
    $storeData->sapaanKK = $request->sapaanKetuaKelompoks;
    $storeData->gelar_awalanKK = $request->gelarAwalanKetuaKelompoks;
    ...
    if($storeData){
      ...
      if ($addUser) {
        return redirect()->route('data-ketua-kelompok.indexKetuaLokasiGKP')->with(['success' => 'Ketua Kelompok Berhasil Disimpan!']);
      }else{
        return redirect()->route('data-ketua-kelompok.indexKetuaLokasiGKP')->with(['error' => 'Ketua Kelompok Gagal Disimpan!']);
      }
    }else{
      return redirect()->route('data-ketua-kelompok.indexKetuaLokasiGKP')->with(['error' => 'Ketua Kelompok Gagal Disimpan!']);
    }
  ...
  public function destroyKetuaLokasiGKP($id)
  {
    ...
    if($deleteDataKetuaKelompok){
      return redirect()->route('data-ketua-kelompok.indexKetuaLokasiGKP')->with(['success' => 'Ketua Kelompok Berhasil Dihapus!']);
    }else{
      return redirect()->route('data-ketua-kelompok.indexKetuaLokasiGKP')->with(['error' => 'Ketua Kelompok Gagal Dihapus!']);
    }
  }
