...
class DataLembagaController extends Controller
{
  ...
  public function indexPengurusPM()
    ...
    return view('parousia-ministry.pengurus.ketua-kelompok', compact(['dataLembagas', 'nodataLembagas', 'noNamaKelompoks', 'pekerjaans', 'statusPekerjaans', 'lokasis', 'sektorIndustris', 'tingkatPendidikans', 'sekolahUnivs',
                                                      'bidKeterampilans', 'bidKetertarikans', 'persMbtis', 'persHollands', 'spiritGifts', 'abilities', 'gandaLimas', 'kemBahasas',
                                                      'kc_pilsatus', 'kc_pilduas', 'kc_piltigas', 'kc_pilempats', 'kc_pillimas', 'kc_pilenams', 'kc_piltujuhs', 'nominals', 'namaKelompoks']));
  }
  ...
  public function storePengurusPM(Request $request)
  {
    ...
    if($storeDataSave){
      ...
      if ($addUser) {
        return redirect()->route('ketua-kelompok.indexPengurusPM')->with(['success' => 'Data Berhasil Disimpan!']);
      }else{
        return redirect()->route('ketua-kelompok.indexPengurusPM')->with(['error' => 'Data Gagal Disimpan!']);
      }
    }else{
      return redirect()->route('ketua-kelompok.indexPengurusPM')->with(['error' => 'Data Gagal Disimpan!']);
    }
  ...
  public function destroyPengurusPM($id)
  {
    ...
    if($deleteData){
      return redirect()->route('ketua-kelompok.indexPengurusPM')->with(['success' => 'Data Berhasil Dihapus!']);
    }else{
      return redirect()->route('ketua-kelompok.indexPengurusPM')->with(['error' => 'Data Gagal Dihapus!']);
    }
  } 
  ...
  public function indexKetuaLokasiPM()
    ...
    return view('parousia-ministry.ketua-lokasi.ketua-kelompok', compact(['dataLembagas', 'nodataLembagas', 'noNamaKelompoks', 'pekerjaans', 'statusPekerjaans', 'lokasis', 'sektorIndustris', 'tingkatPendidikans', 'sekolahUnivs',
                                                      'bidKeterampilans', 'bidKetertarikans', 'persMbtis', 'persHollands', 'spiritGifts', 'abilities', 'gandaLimas', 'kemBahasas',
                                                      'kc_pilsatus', 'kc_pilduas', 'kc_piltigas', 'kc_pilempats', 'kc_pillimas', 'kc_pilenams', 'kc_piltujuhs', 'nominals', 'namaKelompoks']));
  }
  ...
  public function storeKetuaLokasiPM(Request $request)
  {
    ...
    if($storeDataSave){
      ...
      if ($addUser) {
        return redirect()->route('ketua-kelompok.indexKetuaLokasiPM')->with(['success' => 'Data Berhasil Disimpan!']);
      }else{
        return redirect()->route('ketua-kelompok.indexKetuaLokasiPM')->with(['error' => 'Data Gagal Disimpan!']);
      }
    }else{
      return redirect()->route('ketua-kelompok.indexKetuaLokasiPM')->with(['error' => 'Data Gagal Disimpan!']);
    }
  ...
  public function destroyKetuaLokasiPM($id)
  {
    ...
    if($deleteData){
      return redirect()->route('ketua-kelompok.indexKetuaLokasiPM')->with(['success' => 'Data Berhasil Dihapus!']);
    }else{
      return redirect()->route('ketua-kelompok.indexKetuaLokasiPM')->with(['error' => 'Data Gagal Dihapus!']);
    }
  } 
  ...
  public function indexPengurusGKP()
  {
    ...
    return view('gereja-kristen-parousia.pengurus.ketua-kelompok', compact(['dataLembagas', 'nodataLembagas', 'noNamaKelompoks', 'pekerjaans', 'statusPekerjaans', 'lokasis', 'sektorIndustris', 'tingkatPendidikans', 'sekolahUnivs',
                                                      'bidKeterampilans', 'bidKetertarikans', 'persMbtis', 'persHollands', 'spiritGifts', 'abilities', 'gandaLimas', 'kemBahasas',
                                                      'kc_pilsatus', 'kc_pilduas', 'kc_piltigas', 'kc_pilempats', 'kc_pillimas', 'kc_pilenams', 'kc_piltujuhs', 'nominals', 'namaKelompoks']));
  }
  ...
  public function storePengurusGKP(Request $request)
  {
    ...
    if($storeDataSave){
      ...
      if ($addUser) {
        return redirect()->route('ketua-kelompok.indexPengurusGKP')->with(['success' => 'Data Berhasil Disimpan!']);
      }else{
        return redirect()->route('ketua-kelompok.indexPengurusGKP')->with(['error' => 'Data Gagal Disimpan!']);
      }
    }else{
      return redirect()->route('ketua-kelompok.indexPengurusGKP')->with(['error' => 'Data Gagal Disimpan!']);
    }
  ...
  public function destroyPengurusGKP($id)
  {
    ...
    if($deleteData){
      return redirect()->route('ketua-kelompok.indexPengurusGKP')->with(['success' => 'Data Berhasil Dihapus!']);
    }else{
      return redirect()->route('ketua-kelompok.indexPengurusGKP')->with(['error' => 'Data Gagal Dihapus!']);
    }
  } 
  ...
  public function storeKetuaLokasiGKP(Request $request)
  {
    ...
    if($storeDataSave){
      ...
      if ($addUser) {
        return redirect()->route('ketua-kelompok.indexKetuaLokasiGKP')->with(['success' => 'Data Berhasil Disimpan!']);
      }else{
        return redirect()->route('ketua-kelompok.indexKetuaLokasiGKP')->with(['error' => 'Data Gagal Disimpan!']);
      }
    }else{
      return redirect()->route('ketua-kelompok.indexKetuaLokasiGKP')->with(['error' => 'Data Gagal Disimpan!']);
    }
  ...
  public function destroyKetuaLokasiGKP($id)
  {
    ...
    if($deleteData){
      return redirect()->route('ketua-kelompok.indexKetuaLokasiGKP')->with(['success' => 'Data Berhasil Dihapus!']);
    }else{
      return redirect()->route('ketua-kelompok.indexKetuaLokasiGKP')->with(['error' => 'Data Gagal Dihapus!']);
    }
  } 
}
