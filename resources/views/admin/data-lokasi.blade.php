...
@section('menu')
  ...
  <li class="nav-item">
    ...
    <ul id="data-master" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
      ...
      <li>
        <a href="{{url('/admin/data-lokasi')}}" class="active">
                        ...
                        <div class="form-group-input">
                          <div class="input-center ps-5">
                            <div class="w-75">
                              ...
                              <div class="mb-3 row">
                                <label for="nama_lokasi" class="col-sm-3 px-1 form-label">Nama Wilayah</label>
                                <div class="col-sm-9">
                                  <input type="text" name="nama_lokasi" class="form-control form-control-sm" id="nama_lokasi" placeholder="Nama Wilayah">
                                  @error('nama_lokasi')
                                    <div class="alert alert-danger d-flex align-items-center alert-size mt-2" role="alert">
                                      <p class="p-1 pb-0" style="font-size: 10pt;">
                                        <svg class="bi flex-shrink-0 me-2" width="15" height="15" role="img" aria-label="Danger:"><use xlink:href="#exclamation-triangle-fill"/></svg>
                              ...
                              <div class="mb-3 row">
                                <label for="kode_wilayah" class="col-sm-3 px-1 form-label">Wilayah</label>
                                <div class="col-sm-9">
                                  <select class="form-select form-select-sm" name="kode_wilayah" aria-label=".form-select-sm example">
                                    <option value="">-Wilayah-</option>
                                      @foreach ($wilayahs as $wilayah)
                                        <option value="{{$wilayah->kode_wilayah}}">{{$wilayah->nama_wilayah}}</option>
                                      @endforeach
                                  </select>
                                  @error('kode_wilayah')
                                    <div class="alert alert-danger d-flex align-items-center alert-size mt-2" role="alert">
                            ...
                            <div class="form-group-input">
                              <div class="input-center ps-5">
                                <div class="w-75">
                                  ...
                                  <div class="mb-3 row">
                                    <label for="editKode_wilayah" class="col-sm-3 px-1 form-label">Provinsi</label>
                                    <div class="col-sm-9">
                                  <select class="form-select form-select-sm" name="editKode_wilayah" aria-label=".form-select-sm example">
                                    <option value="{{$lokasi->kode_wilayah}}">{{$lokasi->kode_wilayah}}</option>
                                    @foreach ($wilayahs as $wilayah)
                                      <option value="{{$wilayah->kode_wilayah}}">{{$wilayah->nama_wilayah}}</option>
                                    @endforeach
                                  </select>
