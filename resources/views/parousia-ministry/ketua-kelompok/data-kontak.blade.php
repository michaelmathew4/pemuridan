                        ...
                        <div class="input-center ps-5">
                          <div class="w-75">
                            ...
                            <div class="mb-3 row">
                              ...
                              <div class="col-sm-9">
                                <select class="form-select form-select-sm" aria-label=".form-select-sm example" name="institusiPeserta" id="institusiPeserta" disabled>
                            ...
                            <div class="mb-3 row">
                              ...
                              <div class="col-sm-9">
                                ...
                                <select class="form-select form-select-sm" name="pemintaInput" id="pemintaInput" aria-label=".form-select-sm pemintaInput" disabled>
              ...
              <tbody>
                @forelse ($pesertas as $peserta)
                  <tr>
                    ...
                    <td>
                      <a data-bs-toggle="modal" data-bs-target="#lihatSkala" id="lihatSkalaButton" class="text-info" data-attr="{{route('data-kontak.showDataKKPM', $peserta->id_peserta)}}" data-id="{{$peserta->id_peserta}}">
                    ...
                    <td>
                      <a data-bs-toggle="modal" data-bs-target="#lihatCatatan" id="lihatCatatanButton" class="text-info" data-attr="{{route('data-kontak.showDataKKPM', $peserta->id_peserta)}}" data-id="{{$peserta->id_peserta}}">
